...
public class Choix_ville extends ActionBarActivity {
    private static String url = lienhebergement.lien+"villes_events.php";
    private ArrayList<Cons_events> list_item_des=new ArrayList<Cons_events>();
    private JSONArray all_events = null;
    private ProgressDialog pDialog;
    private RecyclerView recyclerView_ville;
    private StaggeredGridLayoutManager mLayoutManager;
    private String type_item;
    private TextView empty;
    private static String TAG = Choix_ville.class.getSimpleName();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_choix_ville);
        setSupportActionBar(toolbar);

        TextView mTitle = (TextView) toolbar.findViewById(R.id.toolbar_title_ville);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Choix_ville.this.finish();
            }
        });

        LinearLayoutManager layoutManager = new LinearLayoutManager(Choix_ville.this);
        ...
        recyclerView_ville = (RecyclerView)findViewById(R.id.recycler_viewville);
        Cathegorie_adaptateur chategorieadaptateur = new Cathegorie_adaptateur(Choix_ville.this, list_item_des);
        recyclerView_ville.setAdapter(chategorieadaptateur);
        recyclerView_ville.setItemAnimator(new DefaultItemAnimator());
        recyclerView_ville.setLayoutManager(new LinearLayoutManager(Choix_ville.this));//
        // recyclerView.setLayoutManager(mLayoutManager);
        recyclerView_ville.setHasFixedSize(true);
        empty=(TextView)findViewById(R.id.textempty_ville);
    }
    ...
    private class GetEvants extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Choix_ville.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                ...
                try {
                    ...
                    Log.d("all categories ville: ", "> " + all_events);
                    ...
                    for (int i = 0; i < all_events.length(); i++) {
                        ...
                        String ville_event = c.getString("ville");
...
//                mEmptyLayout.setEmptyMessage("Aucun événement disponible !");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_choix_ville, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_parametre) {
            Intent parametre=new Intent(Choix_ville.this,Parametre.class);
