 ...
 */
public class Events_date_adaptateurs extends RecyclerView.Adapter<Events_date_adaptateurs.EventsViewHolder> {

    private Context context;
    private ArrayList<Cons_events> items;


    public Events_date_adaptateurs(Context context, ArrayList<Cons_events> items) {
