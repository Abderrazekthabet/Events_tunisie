...
public class CalendarAdapter extends BaseAdapter {
   ...
   public static ArrayList<Const_calendar> date_collection_arr;
    ...
    public CalendarAdapter(Context context, GregorianCalendar monthCalendar,ArrayList<Const_calendar> date_collection_arr) {
    ...
    public void setEventView(View v,int pos,TextView txt){
        ...
        for (int i = 0; i < len; i++) {
            Const_calendar cal_obj=date_collection_arr.get(i);
            String date=cal_obj.getEVENT_BEGIN_TIME();
    ...
    public void getPositionList(String date,final Activity act){
        ...
        int len=date_collection_arr.size();
        for (int i = 0; i < len; i++) {
            Const_calendar cal_collection=Const_calendar.date_collection_arr.get(i);
            String event_date=cal_collection.getEVENT_BEGIN_TIME();
