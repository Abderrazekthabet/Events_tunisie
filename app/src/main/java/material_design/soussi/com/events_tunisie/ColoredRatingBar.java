...
public class ColoredRatingBar extends View {
    ...
    private void init(Context context) {
        ...
        if(mType==SMALL){
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_1_s),BitmapFactory.decodeResource(res, R.drawable.star_orange_s),BitmapFactory.decodeResource(res, R.drawable.star_green_s)};
            progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_0_s);
        }else{
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_1),BitmapFactory.decodeResource(res, R.drawable.star_orange_b),BitmapFactory.decodeResource(res, R.drawable.star_green_b)};
            progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_0);
        }
    }
