 ...
 */
public class Cathegorie_adaptateur extends RecyclerView.Adapter<Cathegorie_adaptateur.EventsViewHolder> {

    private Context context;
    private ArrayList<Cons_events> items;


    public Cathegorie_adaptateur(Context context, ArrayList<Cons_events> items) {
